  ...
  if (completed) {
    return (
      <Result
        ...
        subTitle="Strong match for analytical and technology-focused roles."
        extra={[
          <Button key="report" type="primary" onClick={() => navigate("/app/subscription")}>
            Get Detailed Report
          </Button>,
          <Button key="profile" onClick={() => navigate("/app/profile")}>
            View Profile
          </Button>,
        ]}
      />
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between">
        ...
        <Button
          ...
          onClick={() => {
            if (current === quickPsychometricQuestions.length - 1) {
              addTestHistory({
        ...
        >
          {current === quickPsychometricQuestions.length - 1 ? "Finish Test" : "Next"}
        </Button>
      </div>
    </div>
  );
